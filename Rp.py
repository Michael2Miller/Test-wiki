...
def main():
    ...
    application.add_handler(CommandHandler("search", show_search_options), group=3) # تم تعديل هذا ليعرض الخيارات
    ...
    # تم دمج مستجيبات الأزرار هنا (يجب أن يتم استدعاؤها في مكانها الصحيح)

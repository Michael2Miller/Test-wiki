...
async def broadcast_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    message_to_send = None # هذا سيحمل الكابشن النظيف (بدون الأمر)
    ...
    # وضع التحليل للبادئة (نستخدم None لضمان عدم حدوث خطأ في البادئة التي تحتوي على علامات اقتباس)
        ...
        try:
            ...
            if is_media_broadcast:
                ...
                await context.bot.send_message(
                    ...
                    protect_content=False # البادئة غير محمية
                )
                ...
                await context.bot.copy_message(
                    ...
                    caption=message_to_send, # الكابشن النظيف (بدون /broadcast)
                ...
                # إذا كان بثاً نصياً، ادمجه مع البادئة (لأن النصوص تعمل بشكل جيد)

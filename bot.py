...
async def sendid_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # (الإصلاح: إزالة parse_mode للسماح بالروابط واليوزرات)
...
async def broadcast_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # (الإصلاح: إزالة /broadcast من الرسالة)
    if message_to_send and message_to_send.startswith("/broadcast"):
        message_to_send = message_to_send[len("/broadcast"):].strip()

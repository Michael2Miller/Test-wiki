...
LANGUAGES = {
    ...
    'es': {
        ...
        'globally_banned': "🚫 Tu acceso a este bot ha sido suspendido permanently.",
...
# --- [دالة البث المعدلة (الأكثر أهمية)] ---
async def broadcast_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if raw_text and raw_text.startswith("/broadcast"):
        ...
        # إذا كان بثاً نصياً ولم يستخدم الأمر (يجب أن يستخدم الأمر)
...
def main():
    ...
    # 2. مستجيب لبث الوسائط (صور/فيديو/ملفات)
